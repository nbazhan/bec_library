classdef ZNGtask < gpe_yb.GPEtask
    ...
    methods
        function obj = ZNGtask(grid,trappot)
            obj = obj@gpe_yb.GPEtask(grid,trappot);
            obj.grid_nt = gpe_yb.grid3d(grid.x(end)*2,grid.nx*2,grid.y(end)*2,grid.ny*2,grid.z(end)*2,grid.nz*2);
